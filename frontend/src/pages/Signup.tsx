...
export default function Signup(props: { onAuth: (next: AuthState) => void }) {
  const navigate = useNavigate();
  const [name, setName] = useState("Aarav");
  const [email, setEmail] = useState(`user${Math.floor(Math.random() * 1000)}@swiftcart.demo`);
  ...
  return (
    <div className="mx-auto max-w-md">
      <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
        ...
        <p className="mt-1 text-sm text-slate-300">Make your SwiftCart profile and start shopping.</p>
